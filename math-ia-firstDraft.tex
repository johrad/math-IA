...
\begin{document}
    ...
    In this phase, the rocket tries to navigate through the atmosphere through the use of its extendable "Grid fins" % (seen in Figure 1.2). 
    ...
    % \includegraphics[scale=0.5]{grid-fins.jpg}
